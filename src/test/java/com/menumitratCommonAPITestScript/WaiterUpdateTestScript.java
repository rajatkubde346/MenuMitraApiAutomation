...
public class WaiterUpdateTestScript extends APIBase
{
    ...
    private void updateWaiter(String apiName, String testCaseid, String testType, String description,
        ...
        try {
            ...
            if(apiName.equalsIgnoreCase("waiterupdate")) {
                ...
                waiterUpdateRequest.setUser_id(requestBodyJson.getString("waiter_id"));
                waiterUpdateRequest.setName(requestBodyJson.getString("name"));
                waiterUpdateRequest.setMobile(requestBodyJson.getString("mobile"));
                waiterUpdateRequest.setAddress(requestBodyJson.getString("address"));
                waiterUpdateRequest.setAadhar_number(requestBodyJson.getString("aadhar_number"));
                waiterUpdateRequest.setDob(requestBodyJson.optString("dob", null));
                waiterUpdateRequest.setEmail(requestBodyJson.getString("email"));
                ...
                LogUtils.info("Waiter update response received successfully");
                ExtentReport.getTest().log(Status.PASS, "Waiter update response received successfully");
                ExtentReport.getTest().log(Status.PASS, "Response: " + response.asPrettyString());
                
                LogUtils.success(logger, "Waiter update test completed successfully");
                ExtentReport.getTest().log(Status.PASS, MarkupHelper.createLabel("Waiter update test completed successfully", ExtentColor.GREEN));
            }
        } catch (Exception e) {
            String errorMsg = "Error in waiter update test: " + e.getMessage();
            LogUtils.exception(logger, errorMsg, e);
            ExtentReport.getTest().log(Status.FAIL, MarkupHelper.createLabel(errorMsg, ExtentColor.RED));
            if (response != null) {
