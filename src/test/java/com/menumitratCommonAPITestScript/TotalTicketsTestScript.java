...
public class TotalTicketsTestScript extends APIBase
{
    ...
    @DataProvider(name = "getTotalTicketsNegativeData")
    public Object[][] getTotalTicketsNegativeData() throws customException {
        try {
            LogUtils.info("Reading total tickets negative test scenario data");
            ExtentReport.getTest().log(Status.INFO, "Reading total tickets negative test scenario data");
            ...
            if (filteredData.isEmpty()) {
                String errorMsg = "No valid total tickets negative test data found after filtering";
                LogUtils.failure(logger, errorMsg);
                ExtentReport.getTest().log(Status.FAIL, MarkupHelper.createLabel(errorMsg, ExtentColor.RED));
                throw new customException(errorMsg);
            }
            ...
            LogUtils.failure(logger, "Error in getting total tickets negative test data: " + e.getMessage());
            ExtentReport.getTest().log(Status.FAIL, "Error in getting total tickets negative test data: " + e.getMessage());
            throw new customException("Error in getting total tickets negative test data: " + e.getMessage());
        }
    }

    @Test(dataProvider = "getTotalTicketsNegativeData")
    public void totalTicketsNegativeTest(String apiName, String testCaseid, String testType, String description,
            String httpsmethod, String requestBody, String expectedResponseBody, String statusCode) throws customException {
        try {
            LogUtils.info("Starting total tickets negative test case: " + testCaseid);
            ExtentReport.createTest("Total Tickets Negative Test - " + testCaseid + ": " + description);
            ExtentReport.getTest().log(Status.INFO, "Test Description: " + description);
            
            if (apiName.equalsIgnoreCase("totaltickets") && testType.equalsIgnoreCase("negative")) {
                requestBodyJson = new JSONObject(requestBody);
                
                LogUtils.info("Request Body: " + requestBodyJson.toString());
                ExtentReport.getTest().log(Status.INFO, "Request Body: " + requestBodyJson.toString());
                
                // Set payload for total tickets request
            ...
            String errorMsg = "Error in total tickets negative test: " + e.getMessage();
