...
public class CreateOrderTestScript extends APIBase {
    ...
    public void createCounterOrder(String apiName, String testCaseid, String testType, String description,
        ...
        try {
            ...
            ExtentReport.createTest("Create Counter Order Test - " + testCaseid);
            ExtentReport.getTest().log(Status.INFO, "Create Counter Order Test: " + description);
            ...
            if (apiName.equalsIgnoreCase("createordercounter")) {
                ...
                if (response.getStatusCode() == Integer.parseInt(statusCode)) {
                    LogUtils.success(logger, "Create Counter order API executed successfully");
                    ExtentReport.getTest().log(Status.PASS, MarkupHelper.createLabel("Create Counter order API executed successfully", ExtentColor.GREEN));
