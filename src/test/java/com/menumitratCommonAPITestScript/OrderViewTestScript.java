...
public class OrderViewTestScript extends APIBase
{
    ...
    private OrderRequest orderViewRequest;
    private URL url;
    ...
    private void orderViewSetUp() throws customException
    {
        try
        {
            ...
            orderViewRequest = new OrderRequest();
    ...
    private void verifyOrderView(String apiName, String testCaseid, String testType, String description,
        ...
        try {
            ...
            if (apiName.equalsIgnoreCase("orderview")) {
                ...
                ExtentReport.getTest().log(Status.PASS, "Order view test completed successfully");
            }
        } catch (Exception e) {
