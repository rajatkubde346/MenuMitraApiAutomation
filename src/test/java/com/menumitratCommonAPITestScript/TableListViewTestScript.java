...
public class TableListViewTestScript extends APIBase
{
    ...
    private void verifyTableListView(String apiName, String testCaseid, String testType, String description,
        ...
        try {
            ...
            ExtentReport.getTest().log(Status.INFO, "Setting user_id in request");
            LogUtils.info("Setting user_id in request");
            tablelistviewrequest.setUser_id(String.valueOf(user_id));
            ...
            LogUtils.info("Table list view response received successfully");
            ExtentReport.getTest().log(Status.PASS, "Table list view response received successfully");
